...
// {
//     class GB2312ToUnicode
//     {
//         private static readonly int[] GB2312_Unicode_Table ={
//         #region 转码表
// 				0xA1A1,0x3000,/* '　' -> 12288 */
// 				0xA1A2,0x3001,/* '、' -> 12289 */
// 				0xA1A3,0x3002,/* '。' -> 12290 */
...
//         #endregion
// 
//         //从GB2312字节流中解析出字符，字节数组长度
//         public static string GBToUnicodeForString(byte[] buffer, int index, int length)
//         {
...
//                     //查找对应的Unicode编码
//                     int inx = DichotomySearch(GB2312_Unicode_Table, value, GB2312_Unicode_Table.Length, 0);
//                     if (inx == -1)
//                         return "";
//                     value = GB2312_Unicode_Table[inx + 1];
// 
...
// 
//         //从GB2312字节流中解析出字符，字节数组长度
//         public static byte[] GBToUnicodeForByte(byte[] buffer, int index, int length)
//         {
//             //使用list存储从GB2312转成Unicode的字节码
//             List<byte> data = new List<byte>();
// 
...
//         }
// 
//         //采用二分查找法，查找与GB2312对应的Unicode码
//         private static int DichotomySearch(int[] array, int value, int high, int low)
//         {
//             int middle = 0;
// 
//             if (high < low)
...
//             {
//                 return DichotomySearch(array, value, middle - 2, low);
//             }
//             else
//             {
//                 return DichotomySearch(array, value, high, middle + 2);
//             }
//         }
//     }
// }
