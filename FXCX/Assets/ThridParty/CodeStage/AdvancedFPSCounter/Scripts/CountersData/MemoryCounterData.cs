...
namespace CodeStage.AdvancedFPSCounter.CountersData
{
    ...
    {
        public static int sAnimDataPoolCount = 0;
        ...
        internal override void UpdateValue(bool force)
        {
            ...
            if (monoUsage)
            {
                ...
                {
                    monoDivisionResult = monoMemory * 1.0f / MEMORY_DIVIDER;
            ...
            if (dirty && main.OperationMode == AFPSCounterOperationMode.Normal)
            {
                ...
                if (allocated)
                {
                    ...
                    if (preciseValues)
                    {
                        text.AppendFormat("{0:F2}", lastAllocatedValue / (float)MEMORY_DIVIDER);
                    }
                    else
                    {
                ...
                if (monoUsage)
                {
                    ...
                    {
                        text.AppendFormat("{0:F2}", lastMonoValue);
                    }
